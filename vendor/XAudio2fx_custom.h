...
// XAudio 2.8
interface __declspec(uuid("4FC3B166-972A-40CF-BC37-7DB03DB2FBA3")) AudioVolumeMeter;
interface __declspec(uuid("C2633B16-471B-4498-B8C5-4F0959E2EC09")) AudioReverb;
...
__inline HRESULT XAudio2CreateVolumeMeter(_Outptr_ IUnknown** ppApo)
{
    return CreateAudioVolumeMeter(ppApo);
}

__inline HRESULT XAudio2CreateReverb(_Outptr_ IUnknown** ppApo)
{
